...
//	}
    ...
    public boolean onCommand(Player player, String[] split) {
        ...
        if (command.equalsIgnoreCase("login")) {
            ...
            player.sendMessage(
                    Colors.Green + "Changed your password to: " + Colors.LightBlue + parent.transform(newPass, '*'));
            ...
            for (int i = 1; i < split.length; i++) {
                ...
                if (_player == null) {
                    player.sendMessage(
                            Colors.Rose + "Player " + Colors.LightBlue + playerName + Colors.Rose + " not found.");
                    continue;
                }
                Group mainGroup;
                ...
                if (match) {
                    player.sendMessage(
                            Colors.Rose + "You do not have enough rights to reset " + Colors.LightBlue + playerName);
                    continue;
                }
